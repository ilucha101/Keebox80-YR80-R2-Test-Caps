...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        QK_BOOT, RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______, _______, _______,
...
// Direct Caps Lock indicator test on A15 (active-high).
// RGB chain remains on A10 with led_count 8.
#ifndef CAPS_LOCK_LED_PIN
#    define CAPS_LOCK_LED_PIN A15
#endif
